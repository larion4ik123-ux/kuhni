...
FUNNEL_QUESTIONS = [
    ...
    {
        "key": "room_type",
        "title": "Что сейчас находится в помещении?",
        "description": "Это поможет аккуратно сохранить планировку комнаты на визуализации.",
        "type": "single_choice",
        "order": 5,
        "required": True,
        "active": True,
        "generation_key": "room_type",
    },
    {
        "key": "countertop",
        "title": "Какая столешница вам ближе?",
        "type": "single_choice",
        "order": 9,
        "required": True,
        "active": True,
        "generation_key": "countertop",
    },
    {
        "key": "appliances",
    ...
    },
    {
        ...
        "description": "Отправьте номер кнопкой MAX, чтобы Артём мог связаться и уточнить детали проекта.",
        "type": "contact",
        "order": 14,
        "required": True,
        "active": True,
    ...
    "deadline": [
        {
            ...
            "internal_code": "month",
            "generation_hint": "Проект планируется к реализации в ближайший месяц",
            "order": 1,
        },
        {
            "title": "В течение 2–3 месяцев",
            "internal_code": "quarter",
            "generation_hint": "Проект планируется к реализации в течение двух-трёх месяцев",
            "order": 2,
        },
        {
            "title": "Пока выбираю варианты",
            "internal_code": "research",
            "generation_hint": "Клиент пока выбирает подходящий вариант",
            "order": 3,
        },
    ],
}
...
SITE_BLOCKS = [
    {
        "key": "hero_eyebrow",
        "title": "Надзаголовок",
        "content": "Своё производство в Людинове",
        "order": 1,
    },
    {"key": "hero_title", "title": "Заголовок", "content": "Кухни на заказ без салонных переплат", "order": 2},
    {
        "key": "hero_subtitle",
        "title": "Описание",
        "content": "Проектируем, изготавливаем и устанавливаем кухни точно под ваше помещение. Артём Ермаков лично ведёт каждый заказ от замера до монтажа.",
        "order": 3,
    },
    {
        "key": "hero_image",
    ...
    },
    {
        "key": "benefit_2",
        "title": "Более 10 лет",
        "content": "Изготавливаем мебель в Людинове и ближайших районах",
        "order": 11,
    },
    {
        "key": "benefit_3",
        "title": "Личная гарантия",
        "content": "Артём отвечает за сроки, качество и установку",
        "order": 12,
    },
    {
        "key": "max_title",
        "title": "Заголовок MAX-блока",
        "content": "Посмотрите будущую кухню в своём интерьере",
        "order": 20,
    },
    {
        "key": "max_text",
        "title": "Описание MAX-блока",
        "content": "Ответьте на несколько вопросов и пришлите фото помещения. MAX-бот соберёт пожелания и подготовит визуальный вариант кухни.",
        "order": 21,
    },
    {"key": "works_title", "title": "Заголовок работ", "content": "Кухни, которые уже установлены", "order": 30},
    {
        "key": "works_text",
        "title": "Описание работ",
        "content": "Реальные проекты компании «Интерьер» в Людинове и области.",
        "order": 31,
    },
    {
        "key": "about_title",
        "title": "Заголовок обо мне",
        "content": "Артём Ермаков, основатель «Интерьера»",
        "order": 40,
    },
    {
        "key": "about_text",
    ...
    },
    {
        ...
        "content": "Нас рекомендуют на Яндекс Картах",
        "order": 50,
    },
    {
        "key": "contacts_title",
        "title": "Заголовок контактов",
        "content": "Начнём с вашей кухни",
        "order": 60,
    },
    {
        "key": "contacts_text",
...
INITIAL_MEDIA = {
    ...
    "work_4481": (
        "kitchens_real/work_4481_card.jpg",
        "kitchens_real/work_4481_card.webp",
        "gallery",
    ),
    "work_4490": (
        "kitchens_real/work_4490_card.jpg",
        "kitchens_real/work_4490_card.webp",
        "gallery",
    ),
}
...
INITIAL_GALLERY = [
    ...
    {
        "media": "work_4481",
        "caption": "Кухня в графитовом цвете",
        "alt_text": "Графитовая кухня с древесной фактурой",
        "layout": "straight",
        "display_order": 5,
    },
    {
        "media": "work_4490",
        "caption": "Светлая угловая кухня",
        "alt_text": "Светлая угловая кухня с высокими шкафами",
        "layout": "corner",
        "display_order": 6,
    },
]
