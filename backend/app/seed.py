...
FUNNEL_QUESTIONS = [
    ...
    {
        "key": "room_type",
        "title": "Что сейчас находится на месте будущей кухни?",
        "description": "Коротко опишите, что уже есть в помещении: старая кухня, пустая стена, коммуникации или другое.",
        "type": "text",
        "order": 10,
        "required": True,
        "active": True,
    ...
    {
        "key": "contact",
        "title": "Куда отправить готовую визуализацию?",
        "description": "Оставьте номер телефона кнопкой MAX. Я отправлю результат сюда, а Артём получит собранную заявку.",
        "type": "contact",
        "order": 13,
        "required": True,
        "active": True,
